...
import { signIn, signUp, signInWithGithub, signInWithGoogle } from '@/app/(main)/auth/actions'
      ...
      <div className="flex min-h-screen flex-col lg:flex-row">
        ...
        <div className="relative  flex flex-col justify-center w-full lg:w-[45%] px-6 md:px-12 lg:px-16 py-10 pt-10 lg:pt-0">
          <motion.button
            ...
            whileHover={{ x: -3 }}
            whileTap={{ scale: 0.95 }}
            className="absolute top-2 lg:top-14 left-1 lg:left-20 w-fit flex items-center gap-1.5 text-neutral-400 dark:text-neutral-500 hover:text-neutral-800 dark:hover:text-neutral-200 transition-colors duration-200 group cursor-pointer"
          >
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            >
              ...
              <motion.div variants={fadeUp}>
                ...
                >
                  <PiTerminalFill className="text-xl" />
              ...
              <motion.div variants={fadeUp} className="mt-10 mb-8">
                <h1 className="text-2xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-50 tracking-tight font-sans">
        ...
        <div className="w-full lg:flex lg:w-[55%] relative items-center justify-center  overflow-hidden lg:min-h-screen">
          ...
          >
            <div className="relative w-full h-full border bg-white/90 border-black/20 rounded-2xl overflow-hidden mask-b-from-20% mask-r-from-20% mask-r-to-100% mask-b-to-100% shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
                <video
                src="/keepVideo.mp4"
                autoPlay
                loop
