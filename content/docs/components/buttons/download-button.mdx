...
description: A list of download button components
icon: " "
---
...
<Preview link="buttons/download-button" isBlock={true} language="tsx" code={`
import DownloadButtonGroup from "@/components/lokalhost_io/buttons/download-button";
...
/>`}>
    ...
    <DownloadButtonGroup
            ...
            <DownloadButtonGroup
              config={{
                linux: { downloadUrl: ""},
                            ...
                            size="md"
              wrapperColorClassName='bg-blue-400 rounded-0'
              colorClassName='bg-blue-500 rounded-0'
              platforms={['linux']}
              radius="full"
            />
            <DownloadButtonGroup
              config={{
                            ...
                            wrapperColorClassName="bg-orange-400"
            ...
            <DownloadButtonGroup
              ...
              size="md"
              wrapperColorClassName='bg-white rounded-none!important text-black'
              colorClassName='bg-neutral-100 rounded-none!important'
            ...
            <DownloadButtonGroup
              config={{
                            ...
                            wrapperColorClassName="bg-gradient-to-r from-red-500 to-red-400"
                            colorClassName="bg-gradient-to-r from-red-600 to-red-800"
                            size="md"
              platforms={['mac']}
            />
    </div>
...
<ManualInstallation
  dependencies="motion clsx tailwind-merge react-icons"
...
export function cn(...inputs: ClassValue[]) {
  ...
  componentFileName="components/lokalhost_io/buttons/download-button.tsx"
...
<PropsTable rows={downloadButtonProps} />
